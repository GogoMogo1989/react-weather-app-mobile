    ...
    return(
        <div className="forecastComponents">
            <div className="forecastCard">
                <img src={`http://openweathermap.org/img/wn/${name.list[1].weather[0].icon}@2x.png`}/>
            ...
            <div className="forecastCard">
                <img src={`http://openweathermap.org/img/wn/${name.list[2].weather[0].icon}@2x.png`}/>
            ...
            <div className="forecastCard">
                <img src={`http://openweathermap.org/img/wn/${name.list[3].weather[0].icon}@2x.png`}/>
            ...
            <div className="forecastCard">
                <img src={`http://openweathermap.org/img/wn/${name.list[4].weather[0].icon}@2x.png`}/>
            ...
            <div className="forecastCard">
                <img src={`http://openweathermap.org/img/wn/${name.list[5].weather[0].icon}@2x.png`}/>
